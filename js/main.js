$(document).ready(function(){
  ...
  $('#form_registro_cuenta input, #form_recuperar_password input, #form_ingresar_a_tu_cuenta input').blur(function(){
  ...
  $('#form_recuperar_password #confirm_new_password').blur(function() {
    if ($('#new_password').val() == $('#confirm_new_password').val()) {
      ...
      if($(this).val().match(upperCase) && $(this).val().match(lowerCase) &&  $(this).val().length > 7 && $(this).val().match(numbers)){
          $('form button.main_button').removeClass('btn_disable');
  ...
  $(".wrong_input").after("<div class='my_tooltip'>La contraseña es incorrecta</div>");
